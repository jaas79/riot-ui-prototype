  		...
  		<panel label="Datos generales">
			<row>
				...
				<column size="col-md-6 col-xs-12">
					...
					<date-picker id="alta-seguro" type="date" label="Fecha de Alta en el Seguro" value="2018-01-15" placeholder="Ingresa la fecha de alta" required=true disabled=false format="YYYY/MM/DD" min-date="2018-01-05" max-date="2018-01-20" />
				</column>
			</row>
  		</panel>
